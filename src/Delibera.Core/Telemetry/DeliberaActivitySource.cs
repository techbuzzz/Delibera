...
public static class DeliberaActivitySource
{
    ...
    {
        get => _instance ??= new ActivitySource(DefaultName, "1.0.0");
    }
    ...
    {
        var activity = Instance.StartActivity(operationName, ActivityKind.Internal);
    ...
    {
        return StartActivity(operationName, [new(tagKey, tagValue)]);
    }
