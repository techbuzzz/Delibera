...
///          <item>
///             <term>
///                <see cref="DebateDuration" />
///             </term>
///             <description>Histogram (ms) of total debate duration.</description>
///          </item>
///          <item>
///             <term>
///                <see cref="RoundDuration" />
///             </term>
///             <description>Histogram (ms) of per-round duration, tagged with <c>round_number</c>.</description>
///          </item>
///          <item>
///             <term>
///                <see cref="TokensTotal" />
///             </term>
///             <description>Counter of tokens, tagged with <c>member_name</c> and <c>direction</c>.</description>
///          </item>
///          <item>
///             <term>
///                <see cref="CompressionRatio" />
///             </term>
///             <description>Gauge of the most recent compression ratio.</description>
///          </item>
///          <item>
///             <term>
///                <see cref="DebatesCompleted" />
///             </term>
///             <description>Counter of completed debates, tagged with <c>strategy</c> and <c>success</c>.</description>
///          </item>
///       </list>
///    </para>
/// </remarks>
public static class DeliberaMeter
{
   ...
   public static Histogram<double> DebateDuration =>
      _debateDuration ??= Instance.CreateHistogram<double>(
         ...
         "ms",
         "Total debate execution duration in milliseconds.");
   ...
   public static Histogram<double> RoundDuration =>
      _roundDuration ??= Instance.CreateHistogram<double>(
         ...
         "ms",
         "Per-round debate duration in milliseconds.");
   ...
   public static Counter<long> TokensTotal =>
      _tokensTotal ??= Instance.CreateCounter<long>(
         ...
         "{tokens}",
         "Total tokens consumed by LLM calls, tagged by member and direction.");
   ...
   public static Gauge<double> CompressionRatio =>
      _compressionRatio ??= Instance.CreateGauge<double>(
         ...
         "{ratio}",
         "Most recent compression ratio (compressed / original tokens).");
