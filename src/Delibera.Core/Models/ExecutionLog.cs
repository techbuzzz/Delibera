...
/// <param name="Source">Component that generated the log (e.g., "Chairman", "KnowledgeKeeper", "Compression", "Participant").</param>
    ...
    DateTime Timestamp)
{
   ...
   public static ExecutionLog Info(string source, string message)
       => new(LogLevel.Info, source, message, DateTime.UtcNow);
   ...
   public static ExecutionLog Trace(string source, string message)
       => new(LogLevel.Trace, source, message, DateTime.UtcNow);
   ...
   public static ExecutionLog Warn(string source, string message)
       => new(LogLevel.Warning, source, message, DateTime.UtcNow);
   ...
   public static ExecutionLog Error(string source, string message)
       => new(LogLevel.Error, source, message, DateTime.UtcNow);
