...
/// </summary>
/// <remarks>
/// <para>Keys are derived from a SHA-256 hash of the input text plus the strategy name,
/// ensuring deterministic lookups even for large inputs.</para>
/// <para>The cache has a configurable maximum size and uses LRU-style eviction
/// when the limit is reached.</para>
/// </remarks>
public sealed class CompressionCache
{
   ...
   public string GetSummary() =>
       $"Cache: {Count} entries, {HitCount} hits / {MissCount} misses ({HitRate:P1} hit rate)";
